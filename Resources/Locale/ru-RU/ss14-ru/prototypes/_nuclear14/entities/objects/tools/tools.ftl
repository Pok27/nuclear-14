...
ent-N14AccessConfigurator = справочник по замкам
...
ent-N14ToolboxWeaponMaintenance = набор для починки оружия
    .desc = Набор, используемый для починки оружия. В условиях суровой пустоши, является верным напарником каждого инженера.